      ...
      <div className="card shadow-sm border-0 px-3 rounded-2 mb-3 py-4 mx-auto mt-5">
        ...
        <div className="card-body">
          <form action="/" onSubmit={(e) => this.handleSubmit(e)} encType="multipart/form-data" autoComplete="off">
            ...
            <div className="form-group">
              <label className="mb-0"><p>Your email</p><span className="text-danger"></span></label>
            ...
            <div className="form-group">
              <label className="mb-0"><p>Your contact number (Optional)</p></label>
            ...
            <div className="form-group">
              <label className="mb-0"><p>Message</p><span className="text-danger"></span></label>
